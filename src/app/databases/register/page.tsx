    ...
    const handleRegister = async () => {
        ...
        try {
            const res = await fetch('/api/apilogin/register', {
                ...
                body: JSON.stringify({ nama, email, nama_lengkap, password }),
            });
    ...
    return (
        <div className="relative flex flex-col justify-center items-center min-h-screen">
            ...
            <div className="flex flex-col justify-center items-center my-8 sm:my-10 border rounded-xl border-black dark:border-white">
                <div className="w-[85vw] sm:w-[65vw] md:w-[50vw] lg:w-[35vw] xl:w-[25vw] h-[60vh] flex flex-col items-center rounded-xl p-5 shadow-lg dark:shadow-2xl">
