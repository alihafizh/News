...
import Dasbord from "./lib/dasbord";
        ...
        <div className="flex h-screen"> {/* Set flex container for full height */}
            ...
            <div className="flex flex-col w-full">
                ...
                <div className="bg-blue-700 w-full py-4 h-28 flex justify-between">
                    ...
                    <div>
                        <Link href="/" className="mx-10 w-40 h-14 my-3 text-white border border-blue-800 rounded-lg bg-blue-700 hover:bg-blue-600 transition duration-300 ease-in-out transform hover:scale-105 shadow-md hover:shadow-lg focus:outline-none active:scale-95 active:bg-blue-800  text-center flex items-center justify-center">
                            Home
                        </Link>
                    </div>
                </div>
